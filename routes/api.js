...
const listkey = ["alazeryofc"]; //api key bisa di ubah
...
router.get('/download/shoppe', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.zeks.me/api/shopee?apikey=api-alazery&q=${q}`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/download/unplash', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.zeks.me/api/unsplash?apikey=api-alazery&q=${q}`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/download/sticker', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://api.zeks.me/api/searchsticker?apikey=api-alazery&q=${q}`))
    .then(response => response.json())
        .then(hasil => {
...
router.get("/maker/nulis", async (req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
    let hasil = 'https://api.zeks.xyz/api/nulis?text='+ text +'&apikey=api-alazery' 
    data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/matrix', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/matrix?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/breakwall', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/breakwall?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/flowertext', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/flowertext?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/smoketext', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/smoketext?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/skytext', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/skytext?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/pubglogo', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/pubglogo?text1='+ text1 + '&text2' +'&apikey=api-alazery'
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/bneon', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/bneon?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/naruto', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/naruto?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/teks3d', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/text3dbox?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/epep', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/epep?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/silverbutton', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/splaybutton?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/goldbutton', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/gplaybutton?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
...
router.get('/maker/harta-tahta', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)) {
  let hasil = 'https://api.zeks.xyz/api/hartatahta?text='+ text +'&apikey=api-alazery' 
  data = await fetch(hasil).then(v => v.buffer())
